...
const ROLES = [
  { value: "oracle", label: "Oracle", color: "bg-purple-100 text-purple-700" },
  { value: "admin", label: "Admin", color: "bg-red-100 text-red-700" },
  { value: "staff", label: "Staff", color: "bg-blue-100 text-blue-700" },
  { value: "resident", label: "Resident", color: "bg-green-100 text-green-700" },
  { value: "associate", label: "Associate", color: "bg-amber-100 text-amber-700" },
  { value: "demo", label: "Demo", color: "bg-slate-100 text-slate-700" },
  { value: "public", label: "Public", color: "bg-gray-100 text-gray-500" },
  { value: "prospect", label: "Prospect", color: "bg-cyan-100 text-cyan-700" },
];
          ...
          <div className="flex gap-3 items-end">
            ...
            <div className="w-40">
              ...
              <select
                ...
                className="w-full px-3 py-2 text-sm border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1B6B3A]/30 focus:border-[#1B6B3A] text-slate-900"
              >
                {ROLES.filter((r) => r.value !== "oracle").map((r) => (
