...
export function ReleasesTab() {
  ...
  return (
    <div>
      ...
      {error && (
        <div className="mb-4 text-sm rounded-lg px-4 py-3 bg-red-900/30 border border-red-800 text-red-300">
          {error}
        </div>
      )}
                ...
                {group.prs.map((pr) => {
                  ...
                  return (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 rounded-lg border border-slate-700 px-4 py-3 hover:border-slate-500 hover:bg-white/5 transition-colors group"
                    >
                      {/* Category tag */}
                      <span
