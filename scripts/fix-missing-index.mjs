...
const routes = [
  ...
  [/^SBA Loan 9663307809/, { r2Prefix: 'loans/sba-9663307809-covid-injury', category: 'statement', accountType: 'sba-loan', institution: 'sba', accountName: 'SBA COVID-19 Economic Injury Loan', accountNumber: '9663307809', accountHolder: 'Tesaloop' }],
